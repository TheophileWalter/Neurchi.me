...
function ossn_string_encrypt($string = '', $key = '') {
	...
	return trim(openssl_encrypt($string, "bf-ecb", $key, OPENSSL_RAW_DATA | OPENSSL_NO_PADDING));
}
...
function ossn_string_decrypt($string = '', $key = '') {
	...
	return openssl_decrypt($string, "bf-ecb", $key, OPENSSL_RAW_DATA | OPENSSL_NO_PADDING);
}
